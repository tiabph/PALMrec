function databuf = palmRec_CreateSubImages_cpu(databuf, param)
...
%         if(i==369337)
%             disp(['cx = ' num2str(cx) ', cy=' num2str(cy), ', frame=' num2str(n)]);
%         end
%         up=cy-fitl; 
%         bottom=cy+fitl; 
%         left=cx-fitl;
...
%     end
%     close(h);
    databuf.ROIfit = CreateSubImages(databuf.img, databuf.detectionBuf, fitl);
end