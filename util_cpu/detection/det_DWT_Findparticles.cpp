 ...
 */
int FindParticles(double *pimg, int img_h, int img_w, 
        double *buf_h, double *buf_w, double *buf_peak, int samplewidth);
//result = det_DWT_Findparticles(img, samplewidth)
void mexFunction(
     ...
     int nrhs, const mxArray *prhs[])
{
    ...
    int imgcnt,pnum,m;
    double *pmask = (double *)malloc(Img_h * Img_w * 8);
    double *buf_h = (double *)malloc(Img_h * Img_w * 8);
    double *buf_w = (double *)malloc(Img_h * Img_w * 8);
    double *buf_peak = (double *)malloc(Img_h * Img_w * 8);
