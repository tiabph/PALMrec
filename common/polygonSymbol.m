...
%   $Revision: 1.1.6.7 $  $Date: 2007/12/10 21:38:18 $
   ...
   function setVisible(TF)
    ...
    function manageNumberOfLines(pos)
        ...
        elseif getNumVert(pos)-1 < length(h_top_line)
            lines_to_delete = length(h_top_line):-1:getNumVert(pos);      
    ...
    function wireShiftKeyPointAffordance
        ...
        id_down = iptaddcallback(h_fig,'KeyPressFcn',@keyDown);
        id_up = iptaddcallback(h_fig,'KeyReleaseFcn',@keyUp);
    ...
    function unwireShiftKeyPointAffordance
        ...
        iptremovecallback(h_fig,'KeyPressFcn',id_down);
        iptremovecallback(h_fig,'KeyReleaseFcn',id_up);
