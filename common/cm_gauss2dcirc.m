function [xc,yc,Amp,width]=cm_gauss2dcirc(z,x,y,noiselevel)
% [xc,yc,Amp,width]=cm_gauss2dcirc(arr,x,y,noiselevel) 
% 
% CM_GAUSS2DCIRC attempts to find the best 2D circular Gaussian fit for the 
